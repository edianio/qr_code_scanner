...
class _QRViewState extends State<QRView> {
  ...
  void _onPlatformViewCreated(int id) {
    ...
    final controller =
        QRViewController._(_channel, widget.key as GlobalKey<State<StatefulWidget>>?, widget.onPermissionSet, widget.cameraFacing)
  ...
  static Future<bool> updateDimensions(GlobalKey key, MethodChannel channel, {QrScannerOverlayShape? overlay}) async {
    if (defaultTargetPlatform == TargetPlatform.iOS) {
      ...
      await channel.invokeMethod('changeScanArea',
          {'scanAreaWidth': overlay.cutOutWidth, 'scanAreaHeight': overlay.cutOutHeight, 'cutOutBottomOffset': overlay.cutOutBottomOffset});
      return true;
    }
    return false;
  }
